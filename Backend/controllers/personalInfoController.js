...
const savePersonalInfo = (req, res) => {
  ...
  db.query(checkCnicQuery, [cnic], (err, results) => {
    ...
    const insertOrUpdateQuery =
      "INSERT INTO personal_info (cnic, first_name, last_name, gender, dob, religion, disability, disability_description, native_language, blood_group, province, city, postal_address, permanent_address) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE first_name = VALUES(first_name), last_name = VALUES(last_name), gender = VALUES(gender), dob = VALUES(dob), religion = VALUES(religion), disability = VALUES(disability), disability_description = VALUES(disability_description), native_language = VALUES(native_language), blood_group = VALUES(blood_group), province = VALUES(province), city = VALUES(city), postal_address = VALUES(postal_address), permanent_address = VALUES(permanent_address)";
    db.query(
      insertOrUpdateQuery,
      [
        cnic,
